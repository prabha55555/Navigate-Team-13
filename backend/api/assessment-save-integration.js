// Add this to the assessment.js file to integrate the save assessment functionality
...
router.post('/save', authMiddleware, async (req, res) => {
  try {
    ...
    // Set the status to published if it's been marked for publishing
    if (assessmentData.publish === true) {
      assessmentData.status = 'published';
      console.log(`Setting assessment status to published: ${assessmentData.id}`);
    }
